...
# ╔═╡ a5e8b9ab-6e06-4eea-bad0-49938b603b5f
begin
...
# ╔═╡ 287b7ce0-1a46-11ed-076a-593fc52f13c3
md"""
# Transformations and Autodiff

Heart of machine learning

How to think of matrices: as transformations
...
# ╔═╡ 11dc6b4c-75d4-4b03-aa23-4b7781b450be
img_sources = [
...
# ╔═╡ 457ab99d-c46b-414c-8a47-75a87a004d59
md"""
#### Choose an image:
...
# ╔═╡ eabfa27b-18f4-44b7-b61c-fe7e5ce660da
md"""
α = $(@bind α Slider(.1:.1:3, show_value=true))
"""

# ╔═╡ 6d13fef2-c721-457a-a259-ad1a97730994
let
...
# ╔═╡ eaa22c71-fabc-47a6-8e50-38f84fd5d0f8
genlin(a, b, c, d) = ((x, y), ) -> [a*x + b*y ; c*x + d*y]

# ╔═╡ c5b6ae09-b95c-4f93-b55f-81a301ce859b
md"""
...
# ╔═╡ 3fa16c99-14b7-49a3-ae85-59a7141e0eef
img_original = load(download(img_source));

# ╔═╡ 6f959619-f719-474f-9dce-e085dc3ba2b9
...
# ╔═╡ e334dc8f-09a3-4ca6-a21c-95de3040cc83
img = if show_grid
...
# ╔═╡ 0cfb34db-4d05-49eb-beaf-7fb50462aa35
A = [
	a b
	c d
	]

# ╔═╡ f3025193-af68-4028-8df0-8e87f9f1ed3a
det_A = det(A)

# ╔═╡ 36598208-d87e-4e75-a367-24952a302700
T = genlin(a, b, c, d)

# ╔═╡ c8fa1014-80b9-45b5-a6fe-eb4049614c77
begin
	white(c::RGB) = RGB(1,1,1)
	white(c::RGBA) = RGBA(1,1,1,0.75)
end

# ╔═╡ f3c60d61-43fa-444c-9ef5-4f0bf2386431
...
# ╔═╡ 97fcf1c1-da5e-4173-ab2b-636d074f9191
[
	if det_A == 0
		RGB(1.0, 1.0, 1.0)
	else
...
manifest_format = "2.0"
project_hash = "61b7c9a0e3b2697d3a5b321ea83a7a0019f98471"
